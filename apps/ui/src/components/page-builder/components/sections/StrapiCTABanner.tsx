...
export function StrapiCTABanner({
  ...
  return (
    <section className="px-6 2xl:px-0">
       <Container className="relative isolate flex flex-col justify-center gap-6 overflow-hidden bg-muted px-6 py-24 shadow-sm sm:rounded-3xl sm:px-16 lg:flex-row lg:gap-16">
        <div
          className={cn(
